...
&time_control
 ...
 history_outname = './wrfout_d<domain>_<date>_09_base415_noPBLnudging'
 /
 ...
 chem_opt                            = 9, 202, 202,             ! chemistry option, 201 = MOZART-MOSAIC (4 bins + simplified SOA + no aqeuous chemistry), 202 = MOZART-MOSAIC (4 bins + VBS SOA + aqeuous chemistry).
 ...
 emiss_opt                           = 3, 10, 10,                ! anthropogenic emissions, setting, 10 = MOZART (MOZART + aerosols) emissions
...
&time_control
 ...
 !auxinput7_interval_m                = 60,
 force_use_old_data = .true.           !have to use it given version 4.1.5
 history_outname = './wrfout_d<domain>_<date>_09_base'
 /
 ...
 &chem
 kemit                               = 8,         ! number of vertical levels in the emissions input data file
 chem_opt                            = 0!9, 202, 202,             ! chemistry option, 201 = MOZART-MOSAIC (4 bins + simplified SOA + no aqeuous chemistry), 202 = MOZART-MOSAIC (4 bins + VBS SOA + aqeuous chemistry).
 bioemdt                             = 30, 3.0, 3.0,              !* set as previous self-test run, timestep, biogenic, minutes
 photdt                              = 30., 10., 10.,             ! timestep, photolysis, minutes
 chemdt                              = 6, 3.0, 3.0,               !* set as previous self-test run, timestep, chemistry, minutes
 io_style_emissions                  = 1,                         ! anthropogenic emissions, files, two 12-h emissions data files used
